...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_quickrun#ConcurrentProcess#import() abort
    return map({'_vital_depends': '', 'of': '', 'is_busy': '', 'is_done': '', 'log_dump': '', 'shutdown': '', 'log_clear': '', 'consume_all_blocking': '', 'tick': '', 'is_available': '', 'queue': '', 'consume': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_quickrun#ConcurrentProcess#import() abort', printf("return map({'_vital_depends': '', 'of': '', 'is_busy': '', 'is_done': '', 'log_dump': '', 'shutdown': '', 'log_clear': '', 'consume_all_blocking': '', 'tick': '', 'is_available': '', 'queue': '', 'consume': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
