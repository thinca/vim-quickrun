...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_quickrun#Vim#ViewTracer#import() abort
    return map({'jump': '', 'winnr': '', 'exists': '', 'find': '', 'trace_tabpage': '', 'tabnr': '', 'trace_window': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_quickrun#Vim#ViewTracer#import() abort', printf("return map({'jump': '', 'winnr': '', 'exists': '', 'find': '', 'trace_tabpage': '', 'tabnr': '', 'trace_window': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
